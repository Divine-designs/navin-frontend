...
const ShipmentDetail: React.FC = () => {
  ...
  const mockMilestones: MilestoneDetail[] = [
    ...
    },
    {
      ...
      status: 'completed',
      notes: 'Shipment arrived at Philadelphia hub. Passed quality inspection. Temperature maintained within acceptable range.',
      sensorReadings: {
        temperature: '20°C',
        humidity: '50%',
        pressure: '1014 hPa',
    ...
    },
    {
      ...
      status: 'completed',
      notes: 'Package departed Philadelphia hub en route to Boston. Expected arrival tomorrow morning.',
      sensorReadings: {
        temperature: '19°C',
        humidity: '52%',
        pressure: '1015 hPa',
      ...
      <div className="shipment-detail-container">
        <div className="shipment-detail-header">
          <h1 className="shipment-detail-title">
            SHIPMENT <span className="shipment-detail-title-accent">DETAILS</span>
          </h1>
        ...
        <div className="shipment-detail-content">
          <h2 className="milestone-section-title">
            MILESTONE <span className="milestone-section-title-accent">TIMELINE</span>
          </h2>
